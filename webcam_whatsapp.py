...
def send_ntfy():
    ...
    try:
        ...
        response = requests.post(
            ...
            data=(
                "⚠ FALL DETECTED\n\n"
                "Fall detected by Camera 1.\n"
                "Please check the person immediately."
            ).encode("utf-8"),

            headers={
                "Title": "ELDER FALL DETECTED",
                "Priority": "urgent",
                "Tags": "warning"
            },
...
def upload_frame_to_cloudinary(frame):
    ...
    print()
    print(
        "[CLOUDINARY] Uploading fall image..."
    )
...
while True:
    ...
    if (
        ...
        fall_counter >= FALL_CONFIRMATION_FRAMES

        and not fall_alert_sent
